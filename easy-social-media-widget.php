...
Plugin URI:  https://techgurus.co.in/
Description: Easy Social Media Widget is a simple sidebar widget that allows users to input their social media website profile URLs and other subscription options to show an icon on the sidebar to that social media site and more that open up in a separate browser window.
Version:     1.1.0
Author:      Sai Kumar Bhimarasetty
Text Domain: easy-social-media-widget
Author URI:  https://saiwebpro.blogspot.com/
...
function NSMW_load_textdomain() {
	load_plugin_textdomain( 'easy-social-media-widget', false, basename( dirname( __FILE__ ) ) . '/languages' );
}
...
class New_Social_Media extends WP_Widget {
	...
	define("NSMW_TXTDM", "easy-social-media-widget");
	
		$sm_widget_ops = array( 
			'classname' => 'easy-social-media-widget',
			'description' => 'Display Social Media Profiles',
		);
		parent::__construct( 'easy-social-media-widget', __('Social Media Widget', NSMW_TXTDM) , $sm_widget_ops );
	...
	public function form( $instance ) {
		...
		<div id="display-settings-<?php echo $nsmw_widget_id; ?>" style="display: none;">	
			...
			<p>
				<label><?php _e( 'Div Background Color:', NSMW_TXTDM ); ?></label>
			...
			<p>
				<label><?php _e( 'Icon Color:', NSMW_TXTDM ); ?></label>
